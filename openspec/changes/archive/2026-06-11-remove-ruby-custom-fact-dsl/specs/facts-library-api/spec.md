...
- **THEN** discovery loads exactly the opted-in sources with input-contract semantics (external-fact parsing, precedence, `facter.conf` interpretation) identical to the CLI's
